...
def main() -> int:
    ...
    print(f"[daily-auto-fetch] record rows skipped duplicate={result.get('record_rows_skipped_duplicate', 0)}")
    ...
    print(f"[daily-auto-fetch] routine status skipped duplicate={result.get('routine_status_skipped_duplicate', 0)}")
    ...
    print(f"[daily-auto-fetch] status batch skipped duplicate={result.get('status_batch_skipped_duplicate', 0)}")
    print(f"[daily-auto-fetch] channel master rows appended={result.get('channel_master_rows_appended', 0)}")
    print(f"[daily-auto-fetch] channel master rows updated={result.get('channel_master_rows_updated', 0)}")
    print(f"[daily-auto-fetch] channel master rows unchanged={result.get('channel_master_rows_unchanged', 0)}")
